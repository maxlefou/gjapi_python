...
# ================================
# This version is slightly modified for Ren'Py's use. There is only 3 modifications :
# 1. Added "init -5 python:" at the beginning,
# 2. Indenting all the rest of the script.
# 3. Named the extension rpy instead of py
# If you want to use an updated version of the original script, don't forget to do the same modifications. 
# Else, Ren'Py will stupidely ignore the script... :s
# Also, modified or not, this file must keep the LGPL 
# =================================
